  ...
  return (
    <div>
      ...
      <div className="bg-bunker-950">
        <div className="container grid md:grid-cols-8 md:gap-24 py-8 pt-20 md:py-12 md:pt-24">
          <div className="flex flex-col col-span-5 py-12">
            <h1 className="text-4xl md:text-[2.75rem] leading-normal text-white font-semibold mb-4 font-serif">
              {post.title}
            </h1>
