  ...
  return (
    <div className="relative py-32 xl:py-48 mb-32 text-white">
      ...
      <div className="container relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 xl:gap-15">
          {cards.map((card, index) => (
            <div key={index} className="pt-24">
              <div className="relative rounded-sm">
                <div className="absolute inset-0 border-t border-dashed border-white/20 xl:ml-24" />
                <div className="absolute inset-0 border-l border-dashed border-white/20 ml-6 xl:ml-56" />
                <div className="relative flex flex-col xl:flex-row space-x-9 z-10">
                  <img src={card.image.src} className="rounded-sm w-36 h-36 xl:w-48 xl:h-48 -mt-24 -rotate-3 -skew-y-2" />
                  <div className="flex-1 py-9 pl-6 pr-3 lg:py-12 lg:pl-9">
